...
public class PollService {
    ...
    public PagedResponse<PollResponse> getAllPolls(UserPrincipal currentUser, int page, int size) {
        ...
        List<PollResponse> pollResponses = polls.getContent().stream()
    ...
    public PagedResponse<PollResponse> getPollsVotedBy(String username, UserPrincipal currentUser, int page, int size) {
        ...
        // Retrieve all poll details from the voite pollIds
    ...
    public PollResponse getPollById(Long pollId, UserPrincipal currentUser) {
        ...
        return ModelMapper.mapPollToPollResponse(poll, choiceVotesMap,
                ...
                (currentUser == null)
                        ? null
                        : voteRepository.findByUserIdAndPollId(currentUser.getId(), pollId)
                        .map(vote -> vote.getChoice().getId())
                        .orElse(null)
        );
    }
    ...
    public PollResponse castVoteAndGetUpdatedPoll(Long pollId, @Valid VoteRequest voteRequest, UserPrincipal currentUser) {
        ...
        try {
            ...
            log.error("User {} has already voted in Poll {}", currentUser.getId(), pollId);
    ...
    private Map<Long, Long> getPollUserVoteMap(UserPrincipal currentUser, List<Long> pollIds) {
        ...
        return currentUser != null ?
                voteRepository.findByUserIdAndPollIdIn(currentUser.getId(), pollIds).stream()
